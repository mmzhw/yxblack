...
import { message, Button, Table, Modal, Input, Row, Col } from 'antd';
import {
    Link,
                    ...
                    <Row>
                        <Col span={8}>
                            {/* <Popover
                                content={
                                    <div>
                                        <Link className={style['add-link']} to={`${urls.VIDEO_ADD_SIMPLE}?categories=2&bizType=2`}>综艺</Link>
                                        <Link className={style['add-link']} to={`${urls.VIDEO_ADD_SIMPLE}?categories=2&bizType=1`}>剧集</Link>
                                        <Link className={style['add-link']} to={`${urls.VIDEO_ADD_SIMPLE}?categories=1`}>视频</Link>
                                    </div>
                                }
                                trigger='click'
                            ...
                            <Button type='primary' style={ { marginRight: '20px' } }><Link className={style['add-link']} to={`${urls.VIDEO_ADD_SIMPLE}?categories=1`}>新增视频</Link></Button>
