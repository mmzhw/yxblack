...
import { REQ_URL, OTT_MODULE } from '../../constants/constants';
        ...
        if (cards.length > 0) {
            switch (cards[currentCardsIndex].layoutId) {
                case OTT_MODULE.FIRST:
                    modulePre = (<ModuleFirst card={cards[currentCardsIndex]} activateVideoConfig={this.activateVideoConfig.bind(this)} />);
                    break;
                case OTT_MODULE.SECOND:
                    modulePre = (<ModuleSec card={cards[currentCardsIndex]} activateVideoConfig={this.activateVideoConfig.bind(this)} />);
                    break;
                case OTT_MODULE.THIRD:
                    modulePre = (<ModuleFirst card={cards[currentCardsIndex]} activateVideoConfig={this.activateVideoConfig.bind(this)} />);
                    break;
                case OTT_MODULE.FOURTH:
                    modulePre = (<ModuleFourth card={cards[currentCardsIndex]} activateVideoConfig={this.activateVideoConfig.bind(this)} />);
                    break;
