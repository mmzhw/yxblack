...
class ImgInfoConfig extends Component {
    constructor(props) {
        super(props);
        this.state = {
            defaultData: {} // 存放原始数据
    ...
    componentDidMount() {
        this.props.subjectId && this.getInitData();
    }
    ...
    handleSubmit = (e) => {
        ...
        this.props.form.validateFields(async (err, values) => {
            ...
            // 开始改变信息
            this.props.updateSubject(params, true);
        });
    }
...
export default Form.create()(ImgInfoConfig);
